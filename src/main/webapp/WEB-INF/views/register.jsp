...
<head>
    ...
    <script src="<c:url value="/resources/static/js/register.js"/>" type="application/javascript"></script>
				...
				<form id="registration-form" autocomplete="on">
		            <div class="row">
		              <div class="col">
		                  ...
		                  <input type="text" class="form-control" id="first-name" name="firstName" autofocus required/>
		              </div>
		              <div class="col">
		            ...
		            <div class="row">
	            	  <div class="col">
		                ...
		                <input type="email" class="form-control" id="email" name="email" pattern="[a-zA-Z0-9._-]+@[a-z0-9.-]+\.[a-zA-Z]+" aria-describedby="emailHelp" required/>
		                <div id="emailHelp" class="form-text">e.g. abc@example.com</div>
		             </div>
		             <div class="col">
		                   <label for="mobile-number" class="form-label">Mobile<span style="color: red;">&#42;</span></label>
		                   <input type="tel" class="form-control" id="mobile-number" name="mobile" pattern="[0-9]{10}" aria-describedby="mobileHelp" required/>
		            ...
		            <div class="row">
		            	<div class="col">
		                   ...
		                   <input type="date" step="1" class="form-control" id="dob" name="dob" required/>
		                </div>
		              <div class="col">
		            ...
		            <div class="register">
		              <button type="button" id="register-btn" class="btn btn-primary" onclick="validateUser()">Register</button>
		            </div>
         		</form>
			</div>
			<div class="boxdiv3">	
